<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEmployee.aspx.cs" Inherits="ShopPhone1.AddEmployee" %>
  ...
  <div id="wrapper">
   ...
   <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <form id="formAddEmployee" runat="server" >
            <div class="form-group">
              <label>Họ và tên</label>
              <input type="text" class="form-control" id="Text1" runat="server" placeholder="Họ v" name="phone"/>
            </div>
            <div class="form-group">
              <label>Địa chỉ</label>
