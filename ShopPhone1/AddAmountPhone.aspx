<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAmountPhone.aspx.cs" Inherits="ShopPhone1.AddAmountPhone" %>
  ...
  <div id="wrapper">
   ...
   <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <form id="formAddAmoountPhone" runat="server" >
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" runat="server" id="txtAddAmount" placeholder="Thêm số lượng điện thoại" />
            </div>
